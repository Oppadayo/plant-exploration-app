   ...
   const renderNewPlants = (item, index) =>{
    return(
        <View style={{alignItems: 'center', justifyContent: 'center', marginHorizontal: SIZES.base}}>
            ...
            >
                <Image
                    source={item.favourite ? icons.redHeart : icons.greenHeart}
                    resizeMode='contain'
                    style={{
                        width: 20,
                        height: 20
    ...
    const renderFriendsComponent = () =>{
        if(friendList.length == 0){
            ...
            >
                ...
                <Text style={{ marginLeft: 5, color: COLORS.secondy, ...FONTS.body3}}>+{friendList.length - 3} more</Text>
            </View>
        )
        }
    }
    ...
    return(
        <View style={styles.container}>
            ...
            <View style={{ height: "43%", backgroundColor: COLORS.lightGray }}>
                <View style={{
                    flex: 1,
                    borderBottomLeftRadius: 50,
                    borderBottomRightRadius: 50,
            ...
            <View style={{height: '22%', backgroundColor: COLORS.lightGray}}>
                <View style={{ flex: 1, backgroundColor: COLORS.lightGray}}>
                    <View style={{ marginTop: SIZES.radius, marginHorizontal: SIZES.padding }}>
                        <Text style={{ color: COLORS.secondy, ...FONTS.h2}}>Added Friends</Text>
                        <Text style={{ color: COLORS.secondy, ...FONTS.body3}}>{friendList.length} Total</Text>
                        ...
                        <View style={{ flexDirection: 'row', height: '60%'}}>
                            ...
                            <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end'}}>
                                <Text style={{ color: COLORS.secondy, ...FONTS.body3 }}>Add New</Text>
                                <TouchableOpacity
                                    style={{
